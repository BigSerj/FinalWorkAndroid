...
public class Constants {
    ...
    public static final String PERMISSION_RATIONAL_RU = "Не удалось получить местоположение. Проверьте настройки геолокации.";
    public static final String PERMISSION_RATIONAL = "Location permission is needed for core functionality";

    public static final String TOAST_ADD_DELETE_PLACE_PUSH = "New location added.";
    public static final String TOAST_ADD_DELETE_PLACE_PUSH_MISTAKE = "Error adding new location.";
    public static final String TOAST_ADD_DELETE_PLACE_PULL = "Location deleted.";
    public static final String TOAST_ADD_DELETE_PLACE_PULL_MISTAKE = "Error delete new location.";
    public static final String TOAST_ADD_DELETE_PLACE_PULL_EMPTY = "You haven`t any saved places.";
    public static final String TOAST_MY_LOCATION_PUSH = "Your current location.";
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    public static final String URL_GIF_EARTH = "http://mtdata.ru/u19/photoE600/20980696298-0/big.jpeg";
    public static final String URL_GIF_CLOUD = "http://www.playcast.ru/uploads/2015/10/20/15539204.png";
